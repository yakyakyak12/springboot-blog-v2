insert into user_tb(username, password, email, pic_url) values('ssar', '1234', 'ssar@nate.com', 'img.jpg');
insert into user_tb(username, password, email, pic_url) values('cos', '1234', 'cos@nate.com', 'img.jpg');
